...
import { PAYMENT_METHOD_LABELS } from './orderSchema';
import { useRecordManualPayment } from './orderPaymentsApi';

const MANUAL_METHODS = Object.keys(PAYMENT_METHOD_LABELS).filter((m) => m !== 'razorpay');

export function RecordPaymentModal({ orderId, open, onOpenChange, suggestedAmount }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await recordPayment.mutateAsync({ orderId, method, amount: Number(amount), transactionReference });
